...
[v1.2.3](https://www.npmjs.com/package/react-native-custom-calendars)
...
```
$ git clone https://github.com/alihamza1729/react-native-custom-calendars.git
$ npm install
...
```
$ npm install --save react-native-custom-calendars
```
...
`import {`[Calendar](#calendar), [CalendarList](#calendarlist), [Agenda](#agenda)`} from 'react-native-custom-calendars';`
...
```javascript
import {LocaleConfig} from 'react-native-custom-calendars';
